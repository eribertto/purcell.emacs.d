;; note this is xah new empty buffer using xah fly keys
;; tutorial ref is here http://xahlee.info/emacs/misc/xah-fly-keys.html
;; to list all leader keys press Space C+h in command mode

